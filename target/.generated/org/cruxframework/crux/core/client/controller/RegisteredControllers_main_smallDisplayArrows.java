  ...
  public <T> T getController(String controller){
    ...
    if (ret == null){
      if (org.cruxframework.crux.core.client.utils.StringUtils.unsafeEquals(controller, "mainController")){
        webexmeeting.client.MainController_ControllerProxy __cont  = new webexmeeting.client.MainController_ControllerProxy(this.view);
        __cont.screen = iocContainer.getwebexmeeting_client_MainController_MainView(org.cruxframework.crux.core.client.ioc.IoCResource.Scope.LOCAL, null);
